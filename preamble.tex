...
\NewDocumentCommand{\internalPrintAuthors}{ >{\SplitList{,}} m }{%
    \ProcessList{#1}{\printAuthorEmailTouple}
}

% \printAuthorEmailTouple prints the <Author, E-Mail> touple
\NewDocumentCommand{\printAuthorEmailTouple}{ >{\SplitList{,}} m }{%
    \ifthenelse{\equal{\intcalcMod{\value{authorCounter}}{3}}{0}}{%
        \makecell{
            \ProcessList{#1}{\splitAuthorEmailTouple}
        }
...
% \splitAuthorEmailTouple splits up the author and e-mail address
\newcommand{\splitAuthorEmailTouple}[1]{
...
% \printAuthorName prints the author name
\newcommand{\printAuthorName}[1]{
    \sffamily \textbf{#1} \\
}

% \printAuthorEmail prints the author e-mail address
\newcommand{\printAuthorEmail}[1]{
    \small #1
}